...
export const WidgetMeSmall: FC = () => {
  return (
    <div data-aos="fade-up">
      ...
      >
        <div
          className="flex flex-col justify-between h-full bg-white shadow-sm p-3.5"
    ...
    <div data-aos="fade-up">
      ...
      >
        ...
        >
          <Link href={"/me"}>
            <a
              className={`flex flex-row items-center h-4/7 p-3 pb-2.5 ${
                fix ? "" : "lg:(px-4)"
              }`}
            >
            ...
            >
              {links.map((link: LinkType, index: number) => (
                <a
                  ...
                  key={link.url}
                  href={link.url}
                  className={`rounded-lg lg:rounded-xl flex items-center font-medium text-white justify-center h-full bg-gradient-to-tr ${
                    link.color
                  } ${
                    index === 0
