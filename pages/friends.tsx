        ...
        <div className="flex flex-col items-center justify-between h-full p-5">
                  ...
                  <div
                    className={`w-2 h-2 animate-pulse ${
                      status === Status.online
                        ? Colors["green"].bg.msg
                        : Colors["yellow"].bg.msg
                    } rounded-full`}
                  />
                  {status === Status.online ? "Online" : "Loading"}
                </span>
              ) : (
                <span className="flex items-center justify-center gap-1">
                  <div
                    className={`w-2 h-2 ${Colors["red"].bg.msg} rounded-full`}
                  />
                  Offline
                </span>
              )}
          ...
          <a
            ...
            className={`select-none rounded-full ${
              status === Status.online
                ? Colors["blue"].bg.msg
                : `${Colors["gray"].bg.msg} pointer-events-none`
            } text-white w-16 text-center text-sm p-1`}
          >
            Visit
          </a>
        </div>
